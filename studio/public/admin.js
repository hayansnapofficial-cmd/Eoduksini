...
const labels={active:'활성',trialing:'체험',past_due:'결제 확인',canceled:'해지',unpaid:'미납',incomplete:'미완료',incomplete_expired:'만료',paused:'중지',none:'미구독'};
...
function render(data) {
  ...
  if(!data.customers.length){const row=document.createElement('tr'),empty=cell('조건에 맞는 고객이 없습니다.','empty');empty.colSpan=5;row.append(empty);body.append(row)}
